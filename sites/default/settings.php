...
/**
 * Default database credentials for localhost
 */
$databases = array();
$databases['default']['default'] = array(
  'driver' => 'mysql',
...
/**
 * DB credentials for beta and live sites. Note db.settings.php is not part of
 * the public repo for this site and is environment-specific.
 */
if (file_exists(__DIR__ . '/db.settings.php')) {
  include __DIR__ . '/db.settings.php';
}

/**
 * Local, environment-specific (usually dev-only) settings.
 */
